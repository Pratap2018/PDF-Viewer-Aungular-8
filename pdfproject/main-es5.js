...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, exports, __webpack_require__) {
    ...
    var pdf_lib_1 = __webpack_require__( /*! pdf-lib */"./node_modules/pdf-lib/es/index.js");
    var AppComponent = /*#__PURE__*/_createClass(function AppComponent(document) {
      ...
      (function () {
        return tslib_1.__awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
          var formPdfBytes, emblemImageBytes, emblemImageBytes1, pdfDocLIB, data, pdfDocBytes, loadingTask;
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return fetch('../assets/sample2.pdf').then(function (res) {
                  return res.arrayBuffer();
                });
              case 2:
                formPdfBytes = _context2.sent;
                _context2.next = 5;
                return fetch('../assets/Signature.png').then(function (res) {
                  return res.arrayBuffer();
                });
              case 5:
                emblemImageBytes = _context2.sent;
                _context2.next = 8;
                return fetch('../assets/hypersign.jpg').then(function (res) {
                  return res.arrayBuffer();
                });
              case 8:
                emblemImageBytes1 = _context2.sent;
                _context2.next = 11;
                return pdf_lib_1.PDFDocument.load(formPdfBytes);
              case 11:
                pdfDocLIB = _context2.sent;
                _context2.next = 14;
                return pdfDocLIB.getForm().getField('the Effective Date by and between');
              case 14:
                data = _context2.sent;
                // @ts-ignore
                data.setText('20');
                _context2.t0 = pdfDocLIB.getForm().getButton('Signature-Image-4_af_image');
                _context2.next = 19;
                return pdfDocLIB.embedJpg(emblemImageBytes1);
              case 19:
                _context2.t1 = _context2.sent;
                _context2.next = 22;
                return _context2.t0.setImage.call(_context2.t0, _context2.t1);
              case 22:
                _context2.t2 = pdfDocLIB.getForm().getButton('Signature-Image-1_af_image');
                _context2.next = 25;
                return pdfDocLIB.embedPng(emblemImageBytes);
              case 25:
                _context2.t3 = _context2.sent;
                _context2.next = 28;
                return _context2.t2.setImage.call(_context2.t2, _context2.t3);
              case 28:
                _context2.t4 = pdfDocLIB.getForm().getButton('Signature-Image-2_af_image');
                _context2.next = 31;
                return pdfDocLIB.embedPng(emblemImageBytes);
              case 31:
                _context2.t5 = _context2.sent;
                _context2.next = 34;
                return _context2.t4.setImage.call(_context2.t4, _context2.t5);
              case 34:
                _context2.t6 = pdfDocLIB.getForm().getButton('Signature-Image-3_af_image');
                _context2.next = 37;
                return pdfDocLIB.embedPng(emblemImageBytes);
              case 37:
                _context2.t7 = _context2.sent;
                _context2.next = 40;
                return _context2.t6.setImage.call(_context2.t6, _context2.t7);
              case 40:
                _context2.next = 42;
                return pdfDocLIB.saveAsBase64({
                  dataUri: true
                });
              case 42:
                pdfDocBytes = _context2.sent;
                // @ts-ignore
                ...
                loadingTask.promise.then(function (pdfDocument) {
                  return tslib_1.__awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
                    var page, annotations, container, pdfViewer;
                    return _regeneratorRuntime().wrap(function _callee$(_context) {
                      while (1) switch (_context.prev = _context.next) {
                        ...
                        case 5:
                          ...
                          container = document.getElementById("viewerContainer"); // @ts-ignore
    ...
    }), tslib_1.__param(0, core_2.Inject(common_1.DOCUMENT))], AppComponent);
