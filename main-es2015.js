...
const pdf_lib_1 = __webpack_require__(/*! pdf-lib */ "./node_modules/pdf-lib/es/index.js");
    ...
    constructor(document) {
        ...
        (function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const formPdfBytes = yield fetch('../assets/sample2.pdf').then(res => res.arrayBuffer());
                const emblemImageBytes = yield fetch('../assets/Signature.png').then(res => res.arrayBuffer());
                const emblemImageBytes1 = yield fetch('../assets/hypersign.jpg').then(res => res.arrayBuffer());
                const pdfDocLIB = yield pdf_lib_1.PDFDocument.load(formPdfBytes);
                const data = yield pdfDocLIB.getForm().getField('the Effective Date by and between');
                // @ts-ignore
                data.setText('20');
                yield pdfDocLIB.getForm().getButton('Signature-Image-4_af_image')
                    .setImage(yield pdfDocLIB.embedJpg(emblemImageBytes1));
                yield pdfDocLIB.getForm().getButton('Signature-Image-1_af_image')
                    .setImage(yield pdfDocLIB.embedPng(emblemImageBytes));
                yield pdfDocLIB.getForm().getButton('Signature-Image-2_af_image')
                    .setImage(yield pdfDocLIB.embedPng(emblemImageBytes));
                yield pdfDocLIB.getForm().getButton('Signature-Image-3_af_image')
                    .setImage(yield pdfDocLIB.embedPng(emblemImageBytes));
                const pdfDocBytes = yield pdfDocLIB.saveAsBase64({ dataUri: true });
                // @ts-ignore
...
AppComponent.ctorParameters = () => [
    { type: Document, decorators: [{ type: core_2.Inject, args: [common_1.DOCUMENT,] }] }
];
AppComponent = tslib_1.__decorate([
    ...
    tslib_1.__param(0, core_2.Inject(common_1.DOCUMENT))
], AppComponent);
...
module.exports = __webpack_require__(/*! /home/pratap/pdfproject/src/main.ts */"./src/main.ts");
